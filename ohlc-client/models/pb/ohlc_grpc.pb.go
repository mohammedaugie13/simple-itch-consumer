...
type OHLCServiceClient interface {
	GetOHLC(ctx context.Context, in *StockCode, opts ...grpc.CallOption) (*OHLC, error)
}
...
func (c *oHLCServiceClient) GetOHLC(ctx context.Context, in *StockCode, opts ...grpc.CallOption) (*OHLC, error) {
	out := new(OHLC)
	err := c.cc.Invoke(ctx, "/OHLCService/GetOHLC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OHLCServiceServer interface {
	GetOHLC(context.Context, *StockCode) (*OHLC, error)
...
func (UnimplementedOHLCServiceServer) GetOHLC(context.Context, *StockCode) (*OHLC, error) {
...
func _OHLCService_GetOHLC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/OHLCService/GetOHLC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OHLCServiceServer).GetOHLC(ctx, req.(*StockCode))
	}
